...
@section('content')
{{-- Bagian ini TIDAK akan dicetak --}}
<div class="bg-white/10 backdrop-blur-lg shadow-lg rounded-xl p-6 mb-6 border border-white/10 no-print">
    <form method="GET" action="{{ route('backend.laporan') }}">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
            ...
            {{-- TOMBOL CETAK BARU DITARUH DI SINI --}}
            <div>
                <a href="#" onclick="window.print(); return false;" class="bg-sky-500 hover:bg-sky-600 text-white font-bold py-2 px-4 rounded w-full inline-flex items-center justify-center">
